...
- El agente puede ejecutar acciones autónomas (crear órdenes, ajustar prioridades, reclamar/completar etapas, aprobar saltos o registrar excepciones) siempre respetando los permisos del rol (operador o supervisor) activo.
